...
<?php endif; ?>
		...
		<form method="post" class="login">
			...
			<p class="form-row">
				...
				<input type="submit" class="btn  btn--medium" name="login" value="<?php _e( 'Login', 'woocommerce' ); ?>" />
	...
	<div class="col-2">
		...
		<form method="post" class="register">
			...
			<p class="form-row">
				...
				<input type="submit" class="btn  btn--medium" name="register" value="<?php _e( 'Register', 'woocommerce' ); ?>" />
			</p>
