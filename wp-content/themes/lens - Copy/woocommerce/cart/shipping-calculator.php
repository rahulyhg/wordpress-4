...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h2><a href="#" class="shipping-calculator-button  light"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></h2>
	...
	<section class="shipping-calculator-form" style="display: none;">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="btn btn--medium"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
