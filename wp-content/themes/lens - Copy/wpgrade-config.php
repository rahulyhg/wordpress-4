...
//				'xml-file' => 'lens.xml',
		...
		'custom-css-handler' => 'wpgrade_callback_inlined_custom_style_lens',
				...
				'register' => array
					(
						'head-scripts' => array
							(
								'modernizr' => array(
									'path' => get_template_directory_uri() . '/theme-content/js/vendor/modernizr-2.8.2.min.js',
									'require' => array
									(
										'jquery'
									),
		...
		'pagination-targets' => array
			(
				...
				(
					'formatter' => 'wpgrade_callback_pagination_formatter',
					'prev_text' => __('Prev', 'lens_txtd'),
					'next_text' => __('Next', 'lens_txtd'),
				),
				'portfolio' => array
				(
					'formatter' => 'wpgrade_callback_pagination_formatter',
